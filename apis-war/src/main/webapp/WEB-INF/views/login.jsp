...
<body>
	<div id="loginContainer" class="login-center">
		...
		<div style="text-align: center;">
			<h2>小蜜蜂（v${prop['system.version']}）</h2>
			<h3>
				<a href="http://www.kafeitu.me/about.html" target="_blank"
					style="text-decoration: none;">（By Evan Mu）</a>
			</h3>
		</div>
		<hr />
			...
			<table>
				...
				<tr>
					...
					<td><input id="password" name="password" type="password"
						class="login-input" placeholder="请输入密码" /></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td>
