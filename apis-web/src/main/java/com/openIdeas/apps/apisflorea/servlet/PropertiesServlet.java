package com.openIdeas.apps.apisflorea.servlet;
...
import com.openIdeas.apps.apisflorea.util.LinkedProperties;
...
public class PropertiesServlet extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
		...
		// props.put("http.proxyHost", "10.19.110.32");
		// props.put("http.proxyPort", "8080");
		// props.put("https.proxyHost", "10.19.110.32");
