...
public class UseController {
	...
	public String logon(@RequestParam("username") String userName,
		...
		logger.debug("logon request: {username={}, password={}}", userName,
				password);
		String adminuser = PropertyFileUtil.get("adminuser");
		String adminPwd = PropertyFileUtil.get("adminpwd");
		if (adminuser.equals(userName) && adminPwd.equals(password)) {
			...
			// identityService.createGroupQuery().groupMember(userName).list();
			...
			// }
			// session.setAttribute("groupNames",
