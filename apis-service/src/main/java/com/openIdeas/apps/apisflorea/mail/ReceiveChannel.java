...
public class ReceiveChannel {
	...
	public ReceiveChannel(MimeMessage mimeMessage) {
	 ...
	 * @throws MessagingException
	 */
	public Timestamp getSentDate() throws MessagingException {
	...
	public static void main(String args[]) throws Exception {
		...
		props.put("mail.pop3.connectiontimeout", "800000");
		props.put("mail.pop3.timeout", "80000");
		...
		// + "封===========================");
		// pmm = new ReceiveChannel((MimeMessage) message[i]);
